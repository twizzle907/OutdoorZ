    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                Hometown = UserManager.FindById(User.Identity.GetUserId()).HomeTown
            };
            return View(model);
        }
        ...
        public async Task<ActionResult> UpdateProfile(IndexViewModel model)
        {
            ...
            //user.Email = model.Email;  //Didn't think Email should be updateable due to needing to verify email is real and what not
